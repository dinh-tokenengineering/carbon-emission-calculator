...
if st.button("Calculate CO2 Emissions"):
    ...
    with col4:
        ...
        st.warning(f" A typical tree can absorb around 21 kilograms of carbon dioxide (CO2) per year, however this figure is only achieved when the tree is fully grown. To reach the net-zero emissions, you have to plant {total_tree} tree")
